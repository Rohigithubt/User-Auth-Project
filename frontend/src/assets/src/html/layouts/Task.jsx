...
const Task = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const UserRes = await indexUser(userId);
      if (UserRes?.status) {
  ...
  const handleCreateOrUpdate = async (e) => {
    ...
    if (!userName) {
      setErrors({ username: "Please select a user name" });
      return;
    }
      ...
      <div className="pc-content">
        <div className="row">
          <div className="col-md-12 col-xl-12 mb-4">
            ...
            <div className="mb-3 d-flex justify-content-end" style={{ marginRight: "5px", marginTop: "-55px" }}>
